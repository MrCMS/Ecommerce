...
namespace MrCMS.Web.Apps.Ecommerce.Helpers.NopImport
{
    public static class SeoHelper
    {
        ...
        public static string GetSeoUrl(string entityName, int entityId, string SeName, string Name)
        {
            return entityName + "/" + entityId + "-" + GetSeName(SeName, Name) + ".aspx";
        }
        ...
        private static string GetSeName(string SeName, string Name)
        {
            string seName = GetSeName(SeName);
            if (String.IsNullOrEmpty(seName))
                seName = GetSeName(Name);
            return seName;
        }
