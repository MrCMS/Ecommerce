...
namespace MrCMS.Web.Apps.Ecommerce.Indexing
{
    public class OrderSearchIndex : IndexDefinition<Order>
    {
        ...
        public OrderSearchIndex(ISession session, IEnumerable<IFieldDefinition<OrderSearchIndex, Order>> definitions, IGetLuceneIndexSearcher getLuceneIndexSearcher)
