namespace MrCMS.Web.Apps.Ecommerce.Installation
{
    public static class EcommerceInstalInfo
    {
        ...
        public const string FooterText =
            @"<ul class=""inline""><li><a href=""#"">About &bull;</a></li><li><a href=""#"">Contact Us &bull;</a></li><li><a href=""#"">Privacy Policy &amp; Cookie Info &bull;</a></li><li><a href=""#"">Mr CMS</a></li></ul>";
        ...
        public const string ContactFormDesign = @"{submitted-message}<div class=""row""><div class=""col-xs-12 col-sm-6 col-md-6 col-lg-6""><div class=""form-group"">{validation:Full Name}<input type=""text"" class=""input-lg form-control"" placeholder=""Full Name"" name=""Full Name"" id=""Full_Name""/></div><div class=""form-group"">{validation:Email Address}<input type=""text"" class=""input-lg form-control"" placeholder=""Email Address"" name=""Email Address"" id=""Email_Address""/></div><div class=""form-group"">{validation:Telephone Number}<input type=""text"" class=""input-lg form-control"" placeholder=""Telephone Number"" name=""Telephone Number"" id=""Telephone_Number""/></div></div><div class=""col-xs-12 col-sm-6 col-md-6 col-lg-6""><div class=""form-group"">{validation:Message}<textarea class=""input-lg form-control"" placeholder=""Message"" rows=""3"" style=""height: 108px;"" name=""Message"" id=""Message""></textarea></div><div class=""form-group""><input type=""submit"" value=""Submit"" class=""btn btn-lg btn-block btn-default"" /></div></div></div>";
    }
