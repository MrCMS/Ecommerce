...
window.Chart = function (context) {
    ...
    //CUSTOM - added some height because of labels
    ...
    this.Line = function (data, options) {
        ...
        chart.Line.defaults = {
            ...
            scaleValuePaddingX: 0,
            scaleValuePaddingY: 15,
            scaleOverlay: false,
            scaleOverride: false,
            scaleSteps: null,
            scaleStepWidth: null,
    ...
    var Line = function (data, config, ctx) {
        ...
        function calculateXAxisSize() {
            ...
            xAxisPosY = scaleHeight +20+ config.scaleFontSize / 2;
        }
        function calculateDrawingSizes() {
            maxSize = height-20;
        ...
        function drawBars(animPc) {
            ...
            for (var i = 0; i < data.datasets.length; i++) {
                ...
                for (var j = 0; j < data.datasets[i].data.length; j++) {
                    ...
                    //CUSTOM: Show values for bar chart
                    ctx.save();
                    ctx.textAlign = 'center';
                    ctx.font = config.scaleFontStyle + ' ' + config.scaleFontSize + 'px ' + config.scaleFontFamily;
                    ctx.fillStyle = config.scaleFontColor;
                    if (data.datasets[i].data[j] != 0) {
                        ctx.fillText(data.datasets[i].data[j], barOffset + (barWidth / 2), xAxisPosY - animPc - 20);
                    }
                    ctx.restore();
                }
            }
