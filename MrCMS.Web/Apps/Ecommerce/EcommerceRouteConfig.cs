...
namespace MrCMS.Web.Apps.Ecommerce
{
    public static class EcommerceRouteConfig
    {
        ...
        private static void MapCheckoutRoutes(MrCMSAppRegistrationContext context)
        {
            ...
            context.MapRoute("Order Placed - Register and associate order - other", "order-placed/register", new { controller = "OrderPlaced", action = "RegisterAndAssociateOrder" }, new[] { typeof(OrderPlacedController).Namespace });
