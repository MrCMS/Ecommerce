...
{
    public class FeaturedProductsVertical : Widget
    {
        ...
        {
            var model = new FeaturedProductsVerticalViewModel() { Title = this.Name, Products = new List<Product>() };
            try
            {
    ...
    public class FeaturedProductsVerticalViewModel
    {
